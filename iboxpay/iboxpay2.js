...
refreshtokenVal 👉XP_refreshTOKEN2
iboxpayvideoheaderVal👉 XP_iboxpayvideoHEADER2
iboxpayvideobodyVal👉 XP_iboxpayvideoBODY2
...
if ($.isNode() && process.env.XP_refreshTOKEN2) {
    ...
    if (
        process.env.XP_refreshTOKEN2 &&
        process.env.XP_refreshTOKEN2.indexOf(COOKIES_SPLIT) > -1
    ) {
        middlerefreshTOKEN = process.env.XP_refreshTOKEN2.split(COOKIES_SPLIT);
    } else {
        middlerefreshTOKEN = process.env.XP_refreshTOKEN2.split();
    }
    if (process.env.XP_iboxpayvideoHEADER2) {
        if (
            process.env.XP_iboxpayvideoHEADER2 &&
            process.env.XP_iboxpayvideoHEADER2.indexOf(COOKIES_SPLIT) > -1
        ) {
            middleiboxpayvideoHEADER = process.env.XP_iboxpayvideoHEADER2.split(COOKIES_SPLIT);
        } else {
            middleiboxpayvideoHEADER = process.env.XP_iboxpayvideoHEADER2.split();
        }
        if (
            process.env.XP_iboxpayvideoBODY2 &&
            process.env.XP_iboxpayvideoBODY2.indexOf(COOKIES_SPLIT) > -1
        ) {
            middleiboxpayvideoBODY = process.env.XP_iboxpayvideoBODY2.split(COOKIES_SPLIT);
        } else {
            middleiboxpayvideoBODY = process.env.XP_iboxpayvideoBODY2.split();
        }
    }
}
