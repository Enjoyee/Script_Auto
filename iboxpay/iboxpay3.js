...
refreshtokenVal 👉XP_refreshTOKEN3
iboxpayvideoheaderVal👉 XP_iboxpayvideoHEADER3
iboxpayvideobodyVal👉 XP_iboxpayvideoBODY3
...
if ($.isNode() && process.env.XP_refreshTOKEN3) {
    ...
    if (
        process.env.XP_refreshTOKEN3 &&
        process.env.XP_refreshTOKEN3.indexOf(COOKIES_SPLIT) > -1
    ) {
        middlerefreshTOKEN = process.env.XP_refreshTOKEN3.split(COOKIES_SPLIT);
    } else {
        middlerefreshTOKEN = process.env.XP_refreshTOKEN3.split();
    }
    if (process.env.XP_iboxpayvideoHEADER3) {
        if (
            process.env.XP_iboxpayvideoHEADER3 &&
            process.env.XP_iboxpayvideoHEADER3.indexOf(COOKIES_SPLIT) > -1
        ) {
            middleiboxpayvideoHEADER = process.env.XP_iboxpayvideoHEADER3.split(COOKIES_SPLIT);
        } else {
            middleiboxpayvideoHEADER = process.env.XP_iboxpayvideoHEADER3.split();
        }
        if (
            process.env.XP_iboxpayvideoBODY3 &&
            process.env.XP_iboxpayvideoBODY3.indexOf(COOKIES_SPLIT) > -1
        ) {
            middleiboxpayvideoBODY = process.env.XP_iboxpayvideoBODY3.split(COOKIES_SPLIT);
        } else {
            middleiboxpayvideoBODY = process.env.XP_iboxpayvideoBODY3.split();
        }
    }
}
