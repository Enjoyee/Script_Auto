...
refreshtokenVal 👉XP_refreshTOKEN4
iboxpayvideoheaderVal👉 XP_iboxpayvideoHEADER4
iboxpayvideobodyVal👉 XP_iboxpayvideoBODY4
...
if ($.isNode() && process.env.XP_refreshTOKEN4) {
    ...
    if (
        process.env.XP_refreshTOKEN4 &&
        process.env.XP_refreshTOKEN4.indexOf(COOKIES_SPLIT) > -1
    ) {
        middlerefreshTOKEN = process.env.XP_refreshTOKEN4.split(COOKIES_SPLIT);
    } else {
        middlerefreshTOKEN = process.env.XP_refreshTOKEN4.split();
    }
    if (process.env.XP_iboxpayvideoHEADER4) {
        if (
            process.env.XP_iboxpayvideoHEADER4 &&
            process.env.XP_iboxpayvideoHEADER4.indexOf(COOKIES_SPLIT) > -1
        ) {
            middleiboxpayvideoHEADER = process.env.XP_iboxpayvideoHEADER4.split(COOKIES_SPLIT);
        } else {
            middleiboxpayvideoHEADER = process.env.XP_iboxpayvideoHEADER4.split();
        }
        if (
            process.env.XP_iboxpayvideoBODY4 &&
            process.env.XP_iboxpayvideoBODY4.indexOf(COOKIES_SPLIT) > -1
        ) {
            middleiboxpayvideoBODY = process.env.XP_iboxpayvideoBODY4.split(COOKIES_SPLIT);
        } else {
            middleiboxpayvideoBODY = process.env.XP_iboxpayvideoBODY4.split();
        }
    }
}
