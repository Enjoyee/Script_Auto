...
refreshtokenVal 👉XP_refreshTOKEN5
iboxpayvideoheaderVal👉 XP_iboxpayvideoHEADER5
iboxpayvideobodyVal👉 XP_iboxpayvideoBODY5
...
if ($.isNode() && process.env.XP_refreshTOKEN5) {
    ...
    if (
        process.env.XP_refreshTOKEN5 &&
        process.env.XP_refreshTOKEN5.indexOf(COOKIES_SPLIT) > -1
    ) {
        middlerefreshTOKEN = process.env.XP_refreshTOKEN5.split(COOKIES_SPLIT);
    } else {
        middlerefreshTOKEN = process.env.XP_refreshTOKEN5.split();
    }
    if (process.env.XP_iboxpayvideoHEADER5) {
        if (
            process.env.XP_iboxpayvideoHEADER5 &&
            process.env.XP_iboxpayvideoHEADER5.indexOf(COOKIES_SPLIT) > -1
        ) {
            middleiboxpayvideoHEADER = process.env.XP_iboxpayvideoHEADER5.split(COOKIES_SPLIT);
        } else {
            middleiboxpayvideoHEADER = process.env.XP_iboxpayvideoHEADER5.split();
        }
        if (
            process.env.XP_iboxpayvideoBODY5 &&
            process.env.XP_iboxpayvideoBODY5.indexOf(COOKIES_SPLIT) > -1
        ) {
            middleiboxpayvideoBODY = process.env.XP_iboxpayvideoBODY5.split(COOKIES_SPLIT);
        } else {
            middleiboxpayvideoBODY = process.env.XP_iboxpayvideoBODY5.split();
        }
    }
}
