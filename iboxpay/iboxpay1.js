...
refreshtokenVal 👉XP_refreshTOKEN1
iboxpayvideoheaderVal👉 XP_iboxpayvideoHEADER1
iboxpayvideobodyVal👉 XP_iboxpayvideoBODY1
...
if ($.isNode() && process.env.XP_refreshTOKEN1) {
    ...
    if (
        process.env.XP_refreshTOKEN1 &&
        process.env.XP_refreshTOKEN1.indexOf(COOKIES_SPLIT) > -1
    ) {
        middlerefreshTOKEN = process.env.XP_refreshTOKEN1.split(COOKIES_SPLIT);
    } else {
        middlerefreshTOKEN = process.env.XP_refreshTOKEN1.split();
    }
    if (process.env.XP_iboxpayvideoHEADER1) {
        if (
            process.env.XP_iboxpayvideoHEADER1 &&
            process.env.XP_iboxpayvideoHEADER1.indexOf(COOKIES_SPLIT) > -1
        ) {
            middleiboxpayvideoHEADER = process.env.XP_iboxpayvideoHEADER1.split(COOKIES_SPLIT);
        } else {
            middleiboxpayvideoHEADER = process.env.XP_iboxpayvideoHEADER1.split();
        }
        if (
            process.env.XP_iboxpayvideoBODY1 &&
            process.env.XP_iboxpayvideoBODY1.indexOf(COOKIES_SPLIT) > -1
        ) {
            middleiboxpayvideoBODY = process.env.XP_iboxpayvideoBODY1.split(COOKIES_SPLIT);
        } else {
            middleiboxpayvideoBODY = process.env.XP_iboxpayvideoBODY1.split();
        }
    }
}
